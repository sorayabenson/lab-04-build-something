...
module.exports = Router()
    ...
    .get('/search/:query', async (req, res, next) => {
        // try {
        //     const { data } = await axios.get(`https://api.giphy.com/v1/gifs/search?q=${req.params.query}&api_key=${process.env.GIPHY_API_KEY}`);
        ...
        try {
            const gifs = await GifService.loadSearch(req.params.query);
